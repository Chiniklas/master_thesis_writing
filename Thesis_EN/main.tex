...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{00_Settings/00_Packages} 	
\input{00_Settings/01_Package_Setup} 
\input{00_Settings/02_Definitions}  % add your own definitions and commands
...
\Arbeitnr{xxx} % ask your supervisor for the number
\Fakultaet{School of Engineering and Design} % Usually School of Engineering and Design

\Studiengang{} % Your study program, leave empty if study program shouldn't be shown on the title page
...
\BetreutVonPerson{Akhil Sathuluri} % your supervisor
\BetreutVonZweitkorrektor{Hans Zweitkorrektor} % ask your supervisor for the second corrector, leave empty if not applicable
...
\input{00_Settings/03_Titlepage} % DO NOT ALTER
\input{00_Settings/04_Declaration} % DO NOT ALTER
\input{00_Settings/05_Project_Brief} % ADAPT YOUR PROJECT / TASK DESCRIPTION HERE (comment out if not wanted in document)
\input{00_Settings/06_Project_Declaration} % DO NOT ALTER
...
% \include{01_Chapters/01_Explanations}
% \include{01_Chapters/02_Examples}
\include{01_Chapters/01_Introduction}
\include{01_Chapters/02_state_of_the_art}
\include{01_Chapters/03_Methodology}
\include{01_Chapters/04_experiment_training_and_simulation}
\include{01_Chapters/05_experiment_hardware_system}
\include{01_Chapters/06_discussion}
